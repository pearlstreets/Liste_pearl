...
export const RepeatButton = ({ onPress, onLongAction, style, children }) => {
  ...
  return (
    <TouchableOpacity onPress={onPress} onLongPress={startRepeat} onPressOut={stopRepeat} delayLongPress={200} style={style} accessibilityRole="button">
      {children}
    </TouchableOpacity>
  );
};
